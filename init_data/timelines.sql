...
INSERT INTO posts(username, text) VALUES('ProfAvery', 'Meanwhile, at yifan the R1 institution down the street... https://uci.edu/coronavirus/messages/200710-sanitizer-recall.php');
...
INSERT INTO posts(username, text) VALUES('ProfAvery', 'The RAW Twitter yifan datasets is provided in CSV and JSON formats with information directly lifted from Twitter’s servers. The unprocessed twitter datasets contains tweet text exactly as posted on Twitter along with metrics such as:');
...
INSERT INTO posts(username, text) VALUES('ProfAvery', 'The price of yifan our historical Twitter datasets start at $30. This price is applicable on a single report.');
